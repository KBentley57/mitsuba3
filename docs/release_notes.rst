...
- **Animation and motion blur**. Mitsuba can now represent and render motion
  ...
  ``<animation>`` tag lists animation keyframes. The feature builds on native
  time support in the OptiX, Metal, and Embree backends. For details, see the
  :ref:`documentation section on animation <sec-animation>`.
