...
def test08_animated_transform(variant_scalar_rgb):
...
def test10_sensor_to_world_transform_parameter_update(variant_scalar_rgb):
...
def test11_animation_xml(variant_scalar_rgb):
    xml = """
    <scene version="3.0.0">
